...
class AnimatedCanvas(tk.Canvas):
    ...
    def _draw_idle(self):
        # Draw a simple, less resource-intensive idle animation
    ...
    def _draw_listening(self):
        # Draw a simple listening indicator
        center_x, center_y = self.width/2, self.height/2
    ...
    def _draw_processing(self):
        # Draw a simple processing indicator
        center_x, center_y = self.width/2, self.height/2
        angle = time.time() * 2
        for i in range(4):
...
class TrinAssistant:
    def __init__(self, root, debug_mode=False):
        try:
            ...
            print("Creating animation canvas...")
            ...
            # Start button
            self.start_button = ttk.Button(self.main_frame, text="Start Assistant", command=self.start_assistant)
            ...
            print("Setting up window protocol...")
    ...
    def initialize_spotify(self):
        ...
        try:
            ...
            if os.path.exists(config_path):
                ...
                # Create default config file with provided credentials
                config = {
                ...
                print("Created spotify_config.json with your credentials.")
                return
            ...
            try:
                self.spotify = spotipy.Spotify(auth_manager=SpotifyOAuth(
                    ...
                    show_dialog=True  # Show the Spotify login dialog
                ))
                ...
                print("1. Make sure you've added 'http://127.0.0.1:8000/callback' to your Redirect URIs in the Spotify Developer Dashboard")
                print("2. Try clearing the .spotify_cache file if it exists")
                print("3. Make sure you're logged into the correct Spotify account")
                self.spotify = None
                
        except Exception as e:
            print(f"Error in Spotify initialization: {str(e)}")
            traceback.print_exc()
            self.spotify = None
    ...
    def load_configurations(self):
        ...
        try:
            ...
            if os.path.exists(config_path):
                ...
                config = {
                    'weather_api_key': '3abd19d1e099a8d189e6d48ffee0802b'
                }
                with open(config_path, 'w') as f:
                    json.dump(config, f, indent=4)
                print("Created jarvis_config.json with your weather API key.")
        except Exception as e:
    ...
    def start_assistant(self):
        ...
        try:
            ...
            self.start_button.config(text="Stop Assistant", command=self.stop_assistant)
    ...
    def stop_assistant(self):
        ...
        try:
            ...
            self.start_button.config(text="Start Assistant", command=self.start_assistant)
            self.canvas.start_animation("idle")
